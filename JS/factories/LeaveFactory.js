app.factory('LeaveFactory', function($http){
    ...
    factory.total = function(data){
        var promise = $http({
            url:'./FUNCTIONS/Leave/total.php',
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            transformRequest: function(obj) {
                var str = [];
    ...
    factory.cancellation_respond = function(data){
        var promise = $http({
            url:'./FUNCTIONS/Leave/cancellation_respond.php',
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            transformRequest: function(obj) {
                var str = [];
    ...
    factory.leaves_analytics = function(data){
        var promise = $http({
            url:'./FUNCTIONS/Analytics/leaves.php',
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            transformRequest: function(obj) {
                var str = [];
