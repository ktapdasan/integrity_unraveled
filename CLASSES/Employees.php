    ...
    public function fetch_all($data){
        ...
        $sql = <<<EOT
                select 
                    ...
                    (select type from rate_type where pk = cast(employees.details->'company'->'salary'->>'rate_type_pk' as int)) as rate_type,
                    (select period from pay_period where pk = cast(employees.details->'company'->'salary'->>'pay_period_pk' as int)) as pay_period,
